...
$(document).ready(function ()  {
   ...
   /*********************************************************************************************/
    ...
    $("#galway").click(function() {
        player.src = 'java/music/EdSheeran.mp3';
       player.play();
        
    });
    
    $("#castle").click(function() {
        player.src = 'java/music/castleOnTheHill.mp3';
       player.play();
        
    });
    $("#shape").click(function() {
        player.src = 'java/music/shape.mp3';
       player.play();
    ...
    $("#lose").click(function() {
        player.src = 'java/music/LoseYourself.mp3';
       player.play();
        
    });
    
    $("#justLoseIt").click(function() {
        player.src = 'java/music/JustLoseIt.mp3';
       player.play();
        
    });
    $("#mockingbird").click(function() {
        player.src = 'java/music/Mockingbird.mp3';
       player.play();
    });
   ...
   /*********************************************************************************************/
    ...
    $("#idiot").click(function() {
        player.src = 'java/music/AmericanIdiot.mp3';
       player.play();
        
    });
    
    $("#holiday").click(function() {
        player.src = 'java/music/holiday.mp3';
       player.play();
        
    });
    $("#dreams").click(function() {
        player.src = 'java/music/BoulevardOfBrokenDreams.mp3';
       player.play();
    });
    ...
    $("#staunch").click(function() {
        player.src = 'java/music/BeStaunch.mp3';
       player.play();
        
    });
    
    $("#snappin").click(function() {
        player.src = 'java/music/snappin.mp3';
       player.play();
        
    });
    $("#fullFat").click(function() {
        player.src = 'java/music/fullFat.mp3';
       player.play();
    });
